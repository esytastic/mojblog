        ...
        <div class="col-lg-4 about-card">
            ...
            <ul class="social-icons pt-3">
                ...
                <li class="social-item"><a class="social-link" href="#"><i class="ti-twitter"
                            aria-hidden="true"></i></a></li>
                <li class="social-item"><a class="social-link" href="#"><i class="ti-google" aria-hidden="true"></i></a>
                </li>
                <li class="social-item"><a class="social-link" href="#"><i class="ti-instagram"
                            aria-hidden="true"></i></a></li>
                <li class="social-item"><a class="social-link" href="#"><i class="ti-github" aria-hidden="true"></i></a>
                </li>
            </ul>
        </div>
        <div class="col-lg-4 about-card">
            ...
            <div class="portfolio-container">
                <div class="col-md-6 col-lg-4 web new">
                    <div class="portfolio-item">
                        <img src="<?php echo get_template_directory_uri() . "/assets/imgs/web-1.jpg"; ?>"
                            class="img-fluid"
                            alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates">
                        <div class="content-holder">
                            <a class="img-popup"
                                href="<?php echo get_template_directory_uri() . "/assets/imgs/web-1.jpg"; ?>"></a>
                ...
                <div class="col-md-6 col-lg-4 web new">
                    <div class="portfolio-item">
                        <img src="<?php echo get_template_directory_uri() . "/assets/imgs/web-2.jpg"; ?>"
                            class="img-fluid"
                            alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates">
                        <div class="content-holder">
                            <a class="img-popup"
                                href="<?php echo get_template_directory_uri() . "/assets/imgs/web-2.jpg"; ?>"></a>
                            <div class="text-holder">
                                <h6 class="title">WEB</h6>
                                <p class="subtitle">Expedita corporis doloremque velit in totam!</p>
                            </div>
                ...
                <div class="col-md-6 col-lg-4 advertising new">
                    <div class="portfolio-item">
                        <img src="<?php echo get_template_directory_uri() . "/assets/imgs/advertising-2.jpg"; ?>"
                            class="img-fluid"
                            alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates">
                        <div class="content-holder">
                            <a class="img-popup"
                                href="<?php echo get_template_directory_uri() . "/assets/imgs/advertising-2.jpg"; ?>"></a>
                            <div class="text-holder">
                ...
                <div class="col-md-6 col-lg-4 web">
                    <div class="portfolio-item">
                        <img src="<?php echo get_template_directory_uri() . "/assets/imgs/web-4.jpg"; ?>"
                            class="img-fluid"
                            alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates">
                        <div class="content-holder">
                            <a class="img-popup"
                                href="<?php echo get_template_directory_uri() . "/assets/imgs/web-4.jpg"; ?>"></a>
                            <div class="text-holder">
                                <h6 class="title">WEB</h6>
                                <p class="subtitle">Expedita corporis doloremque velit in totam!</p>
                            </div>
                ...
                <div class="col-md-6 col-lg-4 advertising">
                    <div class="portfolio-item">
                        <img src="<?php echo get_template_directory_uri() . "/assets/imgs/advertising-1.jpg"; ?>"
                            class="img-fluid"
                            alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates">
                        <div class="content-holder">
                            <a class="img-popup"
                                href="<?php echo get_template_directory_uri() . "/assets/imgs/advertising-1.jpg"; ?>"></a>
                            <div class="text-holder">
                ...
                <div class="col-md-6 col-lg-4 web new">
                    <div class="portfolio-item">
                        <img src="<?php echo get_template_directory_uri() . "/assets/imgs/web-3.jpg"; ?>"
                            class="img-fluid"
                            alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates">
                        <div class="content-holder">
                            <a class="img-popup"
                                href="<?php echo get_template_directory_uri() . "/assets/imgs/web-3.jpg"; ?>"></a>
                            <div class="text-holder">
                                <h6 class="title">WEB</h6>
                                <p class="subtitle">Expedita corporis doloremque velit in totam!</p>
                            </div>
                ...
                <div class="col-md-6 col-lg-4 advertising new">
                    <div class="portfolio-item">
                        <img src="<?php echo get_template_directory_uri() . "/assets/imgs/advertising-3.jpg"; ?>"
                            class="img-fluid"
                            alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates">
                        <div class="content-holder">
                            <a class="img-popup"
                                href="<?php echo get_template_directory_uri() . "/assets/imgs/advertising-3.jpg"; ?>"></a>
                            <div class="text-holder">
                                <h6 class="title">ADVERSITING</h6>
                                <p class="subtitle">Expedita corporis doloremque velit in totam!</p>
                            </div>
                ...
                <div class="col-md-6 col-lg-4 advertising new">
                    <div class="portfolio-item">
                        <img src="<?php echo get_template_directory_uri() . "/assets/imgs/advertising-4.jpg"; ?>"
                            class="img-fluid"
                            alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates">
                        <div class="content-holder">
                            <a class="img-popup"
                                href="<?php echo get_template_directory_uri() . "/assets/imgs/advertising-4.jpg"; ?>"></a>
                            <div class="text-holder">
                ...
                <div class="col-md-6 col-lg-4 branding new">
                    <div class="portfolio-item">
                        <img src="<?php echo get_template_directory_uri() . "/assets/imgs/branding-1.jpg"; ?>"
                            class="img-fluid"
                            alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates">
                        <div class="content-holder">
                            <a class="img-popup"
                                href="<?php echo get_template_directory_uri() . "/assets/imgs/branding-1.jpg"; ?>"></a>
                            <div class="text-holder">
                ...
                <div class="col-md-6 col-lg-4 branding">
                    <div class="portfolio-item">
                        <img src="<?php echo get_template_directory_uri() . "/assets/imgs/branding-2.jpg"; ?>"
                            class="img-fluid"
                            alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates">
                        <div class="content-holder">
                            <a class="img-popup"
                                href="<?php echo get_template_directory_uri() . "/assets/imgs/branding-2.jpg"; ?>"></a>
                            <div class="text-holder">
                                <h6 class="title">BRANDING</h6>
                                <p class="subtitle">Expedita corporis doloremque velit in totam!</p>
                            </div>
                ...
                <div class="col-md-6 col-lg-4 branding new">
                    <div class="portfolio-item">
                        <img src="<?php echo get_template_directory_uri() . "/assets/imgs/branding-3.jpg"; ?>"
                            class="img-fluid"
                            alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates">
                        <div class="content-holder">
                            <a class="img-popup"
                                href="<?php echo get_template_directory_uri() . "/assets/imgs/branding-3.jpg"; ?>"></a>
                            <div class="text-holder">
                                <h6 class="title">BRANDING</h6>
                                <p class="subtitle">Expedita corporis doloremque velit in totam!</p>
                            </div>
                ...
                <div class="col-md-6 col-lg-4 branding">
                    <div class="portfolio-item">
                        <img src="<?php echo get_template_directory_uri() . "/assets/imgs/branding-4.jpg"; ?>"
                            class="img-fluid"
                            alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates">
                        <div class="content-holder">
                            <a class="img-popup"
                                href="<?php echo get_template_directory_uri() . "/assets/imgs/branding-4.jpg"; ?>"></a>
                            <div class="text-holder">
                                <h6 class="title">BRANDING</h6>
                                <p class="subtitle">Expedita corporis doloremque velit in totam!</p>
                            </div>
                ...
                <div class="col-md-6 col-lg-4 branding">
                    <div class="portfolio-item">
                        <img src="<?php echo get_template_directory_uri() . "/assets/imgs/branding-5.jpg"; ?>"
                            class="img-fluid"
                            alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates">
                        <div class="content-holder">
                            <a class="img-popup"
                                href="<?php echo get_template_directory_uri() . "/assets/imgs/branding-5.jpg"; ?>"></a>
                            <div class="text-holder">
                                <h6 class="title">BRANDING</h6>
                                <p class="subtitle">Expedita corporis doloremque velit in totam!</p>
                            </div>
            ...
            while (have_posts()) {
                ...
                <div class="blog-card">
                    <div class="img-holder">
                        <img src="<?php echo get_template_directory_uri() . "/assets/imgs/blog1.jpg"; ?>"
                    ...
                    <div class="content-holder">
                        ...
                        <p class="post-details">
                            ...
                            <a href="#"><i class="ti-calendar text-danger"></i> <?php echo date_format(date_create(), 'd-M-Y'); ?></a>
